...
def _cluster_inputs(ctx, inputs):
    ...
    if alg == "K-means" or alg is None:
        inputs.int(
                ...
                view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 8}}),
        )
        inputs.int(
                "max_iter",
                label="max_iter",
                description="Maximum number of iterations of the k-means algorithm for a single run",
                view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 300}}),
        )
        inputs.float(
                "tol",
                label="tol",
                ...
                view=types.FieldView(componentsProps={'field': {'min': 0, "step": .00001, "default": 0.0001}}),
        )
        inputs.int(
                "random_state",
                label="random_state",
                description="Determines random number generation for centroid initialization.",
                view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 51}}),
        )
        ...
        inputs.float(
                ...
                view=types.FieldView(componentsProps={'field': {'min': 0.5, "max": 0.99, "step": 0.05, "default": 0.5}}),
        )
        inputs.int(
                "max_iter",
                label="max_iter",
                description="Maximum number of iterations of the k-means algorithm for a single run",
                view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 200}}),
        )
        inputs.int(
                "convergence_iter",
                ...
                view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 15}}),
        )
        inputs.float(
                "preference",
                label="preference",
        ...
        inputs.float(
                ...
                view=types.FieldView(componentsProps={'field': {'min': 0, "max": 1, "step": 0.1, "default": 0.3}}),
        )
        inputs.int(
                "bandwidth_n_samples",
                label="bandwidth_n_samples",
                description="The number of samples to use. If not given, all samples are used.",
                view=types.FieldView(componentsProps={'field': {'min': 1,}}),
                required=False
        )
        inputs.bool(
                "bin_seeding",
        ...
        inputs.int(
                ...
                view=types.FieldView(componentsProps={'field': {'min': 0, "step": 1, "default": 2}}),
        )
        ...
        inputs.float(
            ...
            view=types.FieldView(componentsProps={'field': {'min': 0, "step": 0.1, "default": 0.5}}),
        )
        ...
        inputs.int(
            ...
            view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 5}}),
        )
        ...
        inputs.int(
            ...
            view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 30}}),
        )
        inputs.float(
            "p",
            label="p",
        ...
        inputs.float(
            ...
            description="The number of samples in a neighborhood for a point to be considered as a core \
                point. This includes the point itself.",
            view=types.FieldView(componentsProps={'field': {'min': 0, "step": 0.1, "default": 0.0}}),
        )
        inputs.int(
            "max_cluster_size",
            ...
            view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": None}}),
            required=False
        )
        inputs.float(
            "alpha",
            ...
            view=types.FieldView(componentsProps={'field': {'min': 0, "step": 0.1, "default": 1.0}}),
        )
        alg_choices = ["auto", "ball_tree", "kd_tree", "brute"]
        ...
        inputs.int(
            ...
            view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 40}}),
        )
        ...
        inputs.int(
            ...
            view=types.FieldView(componentsProps={'field': {'min': 1, "step": 1, "default": 50}}),
        )
        inputs.int(
            "n_clusters",
            label="n_clusters",
    ...
    inputs.bool(
            "tag_samples",
            label="Tag Clusters?",
            description="Turn on to tag clusters found",
            view=types.SwitchView(),
            )
